...
module.exports = {
  ...
  downloadInstagram: async function (url, api, event, path) {
    try {
      ...
      const messageBody = `𝗛𝗲𝗿𝗲 𝗶𝘀 𝘆𝗼𝘂𝗿 𝗜𝗻𝘀𝘁𝗮𝗴𝗿𝗮𝗺 𝗩𝗶𝗱𝗲𝗼✅ \n➣🔗 𝗗𝗼𝘄𝗻𝗹𝗼𝗮𝗱 𝗨𝗿𝗹: ${shortUrl}`;
      api.sendMessage({
        body: messageBody,
    ...
    try {
      ...
      if (res.success && res.download && res.download.length > 0) {
        ...
        response.data.on('end', async () => {
          ...
          const messageBody = `𝗛𝗲𝗿𝗲 𝗶𝘀 𝘆𝗼𝘂𝗿 𝗙𝗮𝗰𝗲𝗯𝗼𝗼𝗸 𝗩𝗶𝗱𝗲𝗼✅ \n➣🔗🔗 𝗗𝗼𝘄𝗻𝗹𝗼𝗮𝗱 𝗨𝗿𝗹: ${shortUrl}`;
  ...
  downloadTikTok: async function (url, api, event, path) {
    try {
      ...
      if (res.data.videoUrl) {
        ...
        response.data.on('end', async () => {
          const shortUrl = await shortenURL(videoUrl);
          const messageBody = `𝗛𝗲𝗿𝗲 𝗶𝘀 𝘆𝗼𝘂𝗿 𝗧𝗶𝗸𝗧𝗼𝗸 𝗩𝗶𝗱𝗲𝗼✅ \n➣ 🔗 𝗗𝗼𝘄𝗻𝗹𝗼𝗮𝗱 𝗨𝗿𝗹:: ${shortUrl}`;
  ...
  downloadTwitter: async function (url, api, event, path) {
    try {
      ...
      response.data.on('end', async () => {
        const shortUrl = await shortenURL(videoUrl);
        const messageBody = `𝗛𝗲𝗿𝗲 𝗶𝘀 𝘆𝗼𝘂𝗿 𝗧𝘄𝗶𝘁𝘁𝗲𝗿 𝗩𝗶𝗱𝗲𝗼✅ \n➣ 🔗 𝗗𝗼𝘄𝗻𝗹𝗼𝗮𝗱 𝗨𝗿𝗹: ${shortUrl}`;
  ...
  downloadPinterest: async function (url, api, event, path) {
    try {
      ...
      response.data.on('end', async () => {
        const shortUrl = await shortenURL(videoUrl);
        const messageBody = `𝗛𝗲𝗿𝗲 𝗶𝘀 𝘆𝗼𝘂𝗿 𝗽𝗶𝗻𝘁𝗲𝗿𝗲𝘀𝘁 𝗩𝗶𝗱𝗲𝗼✅ \n➣🔗 𝗗𝗼𝘄𝗻𝗹𝗼𝗮𝗱 𝗨𝗿𝗹:: ${shortUrl}`;
  ...
  downloadYouTube: async function (url, api, event, path) {
    try {
      ...
      response.data.on('end', async () => {
        const shortUrl = await shortenURL(videoUrl);
        const messageBody = `𝗛𝗲𝗿𝗲 𝗶𝘀 𝘆𝗼𝘂𝗿 𝗬𝗼𝘂𝗧𝘂𝗯𝗲  𝗩𝗶𝗱𝗲𝗼✅ \n➣🔗 𝗗𝗼𝘄𝗻𝗹𝗼𝗮𝗱 𝗨𝗿𝗹: ${shortUrl}`;
